...
class Showlist {
  ...
  // decrementSecondIndex(startIndex) {
  //   this.shows.slice(startIndex + 1, this.shows.length).forEach((item) => {
  //     const newId = generateId(getListnameFromId(item.Id), getFirstIndexFromId(item.Id), getSecondIndexFromId(item.Id) - 1);
  //     item.Id = newId;
  //   });
  // }
